...
% Pelvic width: distance between the most lateral pelvic landmarks
switch Cadaver
    case{'TLEM2_0','TLEM2_1'}
        % !!! Assuming symmetry of the pelvis !!!
        % !!! No consideration of the width of the pubic symphysis !!!
...
% HJCASISHight = Distance between HRC and ASIS along Y-Axis
data.T.Scale(1).HJCASISHight = abs(...

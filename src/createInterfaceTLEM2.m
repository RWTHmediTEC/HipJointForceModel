...
gui.Validation.Panel_post_antHJFpercBWsingle = uix.Panel('Parent', gui.Validation.Layout_Grid,...
...
gui.Validation.Panel_post_antHJFpercBWBoxPlot = uix.Panel('Parent', gui.Validation.Layout_Grid,...
    'Title', 'posterior anterior HJF [%BW]', 'FontWeight','bold');
gui.Validation.Panel_SagittalAngleBoxPlot = uix.Panel('Parent', gui.Validation.Layout_Grid,...
    'Title', 'Sagittal Angle [°]','FontWeight', 'bold');
gui.Validation.Panel_inf_supHJFpercBWsingle = uix.Panel('Parent', gui.Validation.Layout_Grid,...
...
gui.Validation.Panel_inf_supHJFpercBWBoxPlot = uix.Panel('Parent', gui.Validation.Layout_Grid,...
    'Title', 'inferior superior HJF [%BW]', 'FontWeight','bold');
gui.Validation.Panel_FrontalAngleBoxPlot = uix.Panel('Parent', gui.Validation.Layout_Grid,...
    'Title', 'Frontal Angle [°]','FontWeight', 'bold');
gui.Validation.Panel_med_latHJFpercBWsingle = uix.Panel('Parent', gui.Validation.Layout_Grid,...
...
gui.Validation.Panel_med_latHJFpercBWBoxPlot = uix.Panel('Parent', gui.Validation.Layout_Grid,...
    'Title', 'medial lateral HJF [%BW]', 'FontWeight','bold');
gui.Validation.Panel_TransverseAngleBoxPlot = uix.Panel('Parent', gui.Validation.Layout_Grid,...
    'Title', 'Transverse Angle [°]', 'FontWeight','bold');

gui.Validation.Axis_post_antHJFpercBWsingle = axes(gui.Validation.Panel_post_antHJFpercBWsingle);
gui.Validation.Axis_SagittalAngleSingle = axes(gui.Validation.Panel_SagittalAngleSingle);
gui.Validation.Axis_post_antHJFpercBWBoxPlot = axes(gui.Validation.Panel_post_antHJFpercBWBoxPlot);
gui.Validation.Axis_SagittalAngleBoxPlot = axes(gui.Validation.Panel_SagittalAngleBoxPlot);
gui.Validation.Axis_inf_supHJFpercBWsingle = axes(gui.Validation.Panel_inf_supHJFpercBWsingle);
gui.Validation.Axis_FrontalAngleSingle = axes(gui.Validation.Panel_FrontalAngleSingle);
gui.Validation.Axis_inf_supHJFpercBWBoxPlot = axes(gui.Validation.Panel_inf_supHJFpercBWBoxPlot);
gui.Validation.Axis_FrontalAngleBoxPlot = axes(gui.Validation.Panel_FrontalAngleBoxPlot);
gui.Validation.Axis_med_latHJFpercBWsingle = axes(gui.Validation.Panel_med_latHJFpercBWsingle);
gui.Validation.Axis_TransverseAngleSingle = axes(gui.Validation.Panel_TransverseAngleSingle);
gui.Validation.Axis_med_latHJFpercBWBoxPlot = axes(gui.Validation.Panel_med_latHJFpercBWBoxPlot);
...
%% Box panel results
    ...
    function updateResults
        ...
        if gui.IsUpdated
            ...
            set(gui.Home.Results.Label_post_antHJFpercBW, 'String',     data.rMagP);
...
%% Update validation tab
    ...
    function updateValidationTab
        ...
        % Reset axes
        delete([...
            gui.Validation.Axis_post_antHJFpercBWsingle.Children,...
            gui.Validation.Axis_inf_supHJFpercBWsingle.Children,...
            gui.Validation.Axis_med_latHJFpercBWsingle.Children,...
            gui.Validation.Axis_FrontalAngleSingle.Children,...
            gui.Validation.Axis_SagittalAngleSingle.Children,...
            gui.Validation.Axis_TransverseAngleSingle.Children]);
        [gui.Validation.Axis_post_antHJFpercBWsingle.XTick,...
            gui.Validation.Axis_inf_supHJFpercBWsingle.XTick,...
            gui.Validation.Axis_med_latHJFpercBWsingle.XTick,...
            gui.Validation.Axis_FrontalAngleSingle.XTick,...
            gui.Validation.Axis_SagittalAngleSingle.XTick,...
            gui.Validation.Axis_TransverseAngleSingle.XTick] = deal(1:length(data.Results));
        [gui.Validation.Axis_post_antHJFpercBWsingle.XTickLabel,...
            gui.Validation.Axis_inf_supHJFpercBWsingle.XTickLabel,...
            gui.Validation.Axis_med_latHJFpercBWsingle.XTickLabel,...
            gui.Validation.Axis_FrontalAngleSingle.XTickLabel,...
            gui.Validation.Axis_SagittalAngleSingle.XTickLabel,...
            gui.Validation.Axis_TransverseAngleSingle.XTickLabel] = deal({data.Results.Subject});
        [gui.Validation.Axis_post_antHJFpercBWsingle.XLim, ...
            gui.Validation.Axis_inf_supHJFpercBWsingle.XLim, ...
            gui.Validation.Axis_med_latHJFpercBWsingle.XLim, ...
            gui.Validation.Axis_FrontalAngleSingle.XLim,...
            gui.Validation.Axis_SagittalAngleSingle.XLim, ...
            gui.Validation.Axis_TransverseAngleSingle.XLim] = deal([0.5, length(data.Results) + 0.5]);

        markerProps.Marker = 'x';
        markerProps.Markersize = 7;
        
        % Panel posterior anterior HJF [%BW]
        plotValidationResults(gui.Validation.Axis_post_antHJFpercBWsingle,...
            gui.Validation.Axis_post_antHJFpercBWBoxPlot,...
            [data.Results(:).OrrMagP],[data.Results(:).rMagP])
        % Panel inferior superior HJF [%BW]
        plotValidationResults(gui.Validation.Axis_inf_supHJFpercBWsingle,...
            gui.Validation.Axis_inf_supHJFpercBWBoxPlot,...
            [data.Results(:).OrrMagP],[data.Results(:).rMagP])
        % Panel medial lateral HJF [%BW]
        plotValidationResults(gui.Validation.Axis_med_latHJFpercBWsingle,...
            gui.Validation.Axis_med_latHJFpercBWBoxPlot,...
            [data.Results(:).OrrMagP],[data.Results(:).rMagP])
        
        % Panel sagittal angle
        plotValidationResults(gui.Validation.Axis_SagittalAngleSingle,...
            gui.Validation.Axis_SagittalAngleBoxPlot,...
            [data.Results(:).OrTheta],[data.Results(:).rTheta])
        % Panel frontal angle
        plotValidationResults(gui.Validation.Axis_FrontalAngleSingle,...
            gui.Validation.Axis_FrontalAngleBoxPlot,...
            [data.Results(:).OrPhi],[data.Results(:).rPhi])
        % Panel transverse angle
        plotValidationResults(gui.Validation.Axis_TransverseAngleSingle,...
            gui.Validation.Axis_TransverseAngleBoxPlot,...
            [data.Results(:).OrAlpha],[data.Results(:).rAlpha])
        ...
        function plotValidationResults(singleHandle, boxPlotHandle, invivo, simulated)
            ...
            boxplot(boxPlotHandle,[invivo',simulated'],{'In-vivo','Simulated'})

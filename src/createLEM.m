...
if data.SurfaceData
    ...
    data.T.Scale(1).Landmarks = struct(...
        ...
        'IIT',LE(1).Mesh.vertices(LE(1).Landmarks.RightInferiorIschialTuberosity.Node,:), ...
        'PIT',LE(1).Mesh.vertices(LE(1).Landmarks.RightPosteriorIschialTuberosity.Node,:), ...
        'IS',LE(1).Mesh.vertices(LE(1).Landmarks.RightIschialSpine.Node,:), ...
        'PIIS',LE(1).Mesh.vertices(LE(1).Landmarks.RightPosteriorInferiorIliacSpine.Node,:), ...
        'PSIS',LE(1).Mesh.vertices(LE(1).Landmarks.RightPosteriorSuperiorIliacSpine.Node,:), ...
        'SIC',LE(1).Mesh.vertices(LE(1).Landmarks.RightSuperiorIliacCrest.Node,:), ...
        'IT',LE(1).Mesh.vertices(LE(1).Landmarks.RightIliacTubercle.Node,:), ...
        ...
        'MP',LE(1).Mesh.vertices(LE(1).Landmarks.RightMedialPubis.Node,:));
...
switch Cadaver
    case{'TLEM2_0','TLEM2_1'}
        IIT2SIP = ...
            transformPoint3d(data.T.LE(1).Landmarks.RightSuperiorIliacCrest.Pos, pTFM) - ...
            transformPoint3d(data.T.LE(1).Landmarks.RightInferiorIschialTuberosity.Pos, pTFM);
...
switch Cadaver
    case{'TLEM2_0','TLEM2_1'}
        % !!! Assuming symmetry of the pelvis !!!
        % !!! No consideration of the width of the pubic symphysis !!!
        IT = transformPoint3d(data.T.LE(1).Landmarks.RightIliacTubercle.Pos, pTFM);

...
%CREATEFEMURCS_TFM_BERGMANN2016 calculates the transformation into
% OrthoLoad's femoral bone coordinate system using the 'RAS' orientation 
% and the hip joint center as origin [Bergmann 2016].
%
% Reference:
